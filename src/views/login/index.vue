  ...
  <div>
    ...
    <el-card class="login-form-layout">
      <el-form autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
        ...
        <h2 class="login-title color-main">Hyperf-cms</h2>
        ...
        <el-form-item>
          <el-input name="captcha" type="text" style="width: 170px; margin-right: 10px" v-model="loginForm.captcha" @keyup.enter.native="handleLogin" placeholder="清输入验证码">
            <span slot="prefix">
