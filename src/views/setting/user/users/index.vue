          ...
          <template slot-scope="scope">
            <el-dropdown size="mini" type="warning" trigger="click">
              <el-button icon="el-icon-menu" type="success" size="mini" class="button-color-red">
                权限菜单<i class="el-icon-arrow-down el-icon--right"></i>
              </el-button>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item divided>
                  <el-button icon="el-icon-key" type="success" class="button-color-green" size="mini" @click="handleViewPermission(scope.row)">功能权限</el-button>
                </el-dropdown-item>
                <el-dropdown-item divided>
