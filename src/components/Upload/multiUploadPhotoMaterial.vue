<template> 
  <div style="margin-bottom: 40px;">
    <el-upload style="position: relative;" ref="upload_photo_material" :action="action"
      :headers="headers" :data="dataObj" list-type="picture" :before-upload="beforeUpload"
      :on-remove="handleRemove" :on-success="handleUploadSuccess" :on-preview="handlePreview"
      :limit="maxCount" :on-exceed="handleExceed" drag multiple>
